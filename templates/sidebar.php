...
// Otomatis aktifkan menu berdasarkan path file, hanya jika $active_page belum ditentukan oleh halaman
$script = $_SERVER['SCRIPT_NAME'];
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo ($role === 'admin') ? ($BASE . '/admin/index.php') : ($BASE . '/guru/index.php'); ?>">
        <div class="sidebar-brand-icon">
            <img class="img-profile rounded-circle"
                src="<?php echo isset($_SESSION['user']['avatar']) && $_SESSION['user']['avatar'] ? ($BASE . '/' . $_SESSION['user']['avatar']) : ($BASE . '/assets/img/undraw_profile.svg'); ?>"
    ...
    <?php if ($role === 'admin'): ?>
        ...
        <li class="nav-item <?php echo $is_data_master_active ? 'active' : ''; ?>">
            ...
            <div id="collapseDataMaster" class="collapse <?php echo $is_data_master_active ? 'show' : ''; ?>" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?php echo ($active_page === 'guru') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/guru/list_guru.php"><i class="fas fa-chalkboard-teacher mr-2 text-gray-400"></i>Data Guru</a>
                    <a class="collapse-item <?php echo ($active_page === 'siswa') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/siswa/list_siswa.php"><i class="fas fa-users mr-2 text-gray-400"></i>Data Siswa</a>
                    <a class="collapse-item <?php echo ($active_page === 'kelas') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/kelas/list_kelas.php"><i class="fas fa-door-open mr-2 text-gray-400"></i>Data Kelas</a>
                    <a class="collapse-item <?php echo ($active_page === 'jurusan') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/jurusan/list_jurusan.php"><i class="fas fa-graduation-cap mr-2 text-gray-400"></i>Data Jurusan</a>
                    <a class="collapse-item <?php echo ($active_page === 'users') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/users/list_users.php"><i class="fas fa-user-cog mr-2 text-gray-400"></i>Manajemen User</a>
                </div>
            </div>
        </li>
        <hr class="sidebar-divider">
        ...
        <li class="nav-item <?php echo $is_whatsapp_active ? 'active' : ''; ?>">
            ...
            <div id="collapseWhatsApp" class="collapse <?php echo $is_whatsapp_active ? 'show' : ''; ?>" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?php echo ($active_page === 'whatsapp_config') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/whatsapp/config.php">
                        <i class="fas fa-cog mr-2 text-gray-400"></i>Konfigurasi
                    </a>
                    <a class="collapse-item <?php echo ($active_page === 'whatsapp_monitoring') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/whatsapp/monitoring.php">
                        <i class="fas fa-desktop mr-2 text-gray-400"></i>Monitoring
                    </a>
                    <a class="collapse-item <?php echo ($active_page === 'whatsapp_templates') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/whatsapp/templates.php">
                        <i class="fas fa-file-alt mr-2 text-gray-400"></i>Template Pesan
                    </a>
                    <a class="collapse-item <?php echo ($active_page === 'whatsapp_automation') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/whatsapp/automation_settings.php">
                        <i class="fas fa-robot mr-2 text-gray-400"></i>Otomatisasi
                    </a>
                    <a class="collapse-item <?php echo ($active_page === 'whatsapp_automation_logs') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/whatsapp/automation_logs.php">
                        <i class="fas fa-history mr-2 text-gray-400"></i>Log Otomatisasi
                    </a>
                    <a class="collapse-item <?php echo ($active_page === 'whatsapp_test') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/whatsapp/test.php">
                        <i class="fas fa-vial mr-2 text-gray-400"></i>Test Koneksi
                    </a>
                    <a class="collapse-item <?php echo ($active_page === 'whatsapp_test_service') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/whatsapp/test_service.php">
        ...
        <li class="nav-item <?php echo $is_laporan_active ? 'active' : ''; ?>">
            ...
            <div id="collapseLaporan" class="collapse <?php echo $is_laporan_active ? 'show' : ''; ?>" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?php echo ($active_page === 'laporan_absensi') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/laporan/laporan_absensi.php">Laporan Absensi</a>
                    <a class="collapse-item <?php echo ($active_page === 'laporan_siswa') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/laporan/laporan_siswa.php">Laporan Siswa</a>
                    <a class="collapse-item <?php echo ($active_page === 'laporan_guru') ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/laporan/laporan_guru.php">Laporan Guru</a>
                    <a class="collapse-item" href="<?= $BASE ?>/admin/laporan/export_excel.php">Export Excel</a>
                    <a class="collapse-item" href="<?= $BASE ?>/admin/laporan/export_pdf.php">Export PDF</a>
                </div>
            </div>
        </li>

        <li class="nav-item <?php echo ($active_page === 'pengaduan') ? 'active' : ''; ?>">
            <a class="nav-link" href="<?= $BASE ?>/admin/pengaduan/list_pengaduan.php">
        ...
        <li class="nav-item <?php echo $is_fingerprint_active ? 'active' : ''; ?>">
            ...
            <div id="collapseFingerprint" class="collapse <?php echo $is_fingerprint_active ? 'show' : ''; ?>" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item <?php echo ($tab === '' || $tab === 'kelola') && strpos($script, 'view_logs.php') === false && strpos($script, 'test_fingerprint_connection.php') === false ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/fingerprint/manage_fingerprint_users.php">Kelola User Fingerprint</a>
                    <a class="collapse-item <?php echo ($tab === 'mapping') && strpos($script, 'view_logs.php') === false && strpos($script, 'test_fingerprint_connection.php') === false ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/fingerprint/manage_fingerprint_users.php?tab=mapping">Mapping UID</a>
                    <a class="collapse-item <?php echo ($tab === 'sinkronisasi') && strpos($script, 'view_logs.php') === false && strpos($script, 'test_fingerprint_connection.php') === false ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/fingerprint/manage_fingerprint_users.php?tab=sinkronisasi">Sinkronisasi User</a>
                    <a class="collapse-item <?php echo (strpos($script, 'view_logs.php') !== false) ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/fingerprint/view_logs.php">Log Fingerprint</a>
                    <a class="collapse-item <?php echo (strpos($script, 'test_fingerprint_connection.php') !== false) ? 'active' : ''; ?>" href="<?= $BASE ?>/admin/fingerprint/test_fingerprint_connection.php">Test Koneksi Device</a>
                </div>
            </div>
        </li>
        <li class="nav-item <?php echo ($active_page === 'realtime') ? 'active' : ''; ?>">
            <a class="nav-link" href="<?= $BASE ?>/admin/realtime/dashboard_realtime.php">
                <i class="fas fa-broadcast-tower"></i><span>Realtime</span>
            </a>
        </li>
        <li class="nav-item <?php echo ($active_page === 'pengaturan_jam_kerja') ? 'active' : ''; ?>">
            <a class="nav-link" href="<?= $BASE ?>/admin/pengaturan_jam_kerja.php">
                <i class="fas fa-clock"></i><span>Pengaturan Jam Kerja</span>
            </a>
        </li>
        <li class="nav-item <?php echo ($active_page === 'jalankan_sinkronisasi') ? 'active' : ''; ?>">
            <a class="nav-link" href="<?= $BASE ?>/admin/jalankan_sinkronisasi.php">
                <i class="fas fa-sync-alt"></i><span>Sinkronisasi Absensi</span>
            </a>
        </li>
        <li class="nav-item <?php echo ($active_page === 'optimize_database') ? 'active' : ''; ?>">
            <a class="nav-link" href="<?= $BASE ?>/admin/optimize_database.php">
                <i class="fas fa-database"></i><span>Optimize Database</span>
            </a>
        </li>
        <hr class="sidebar-divider">
        <li class="nav-item <?php echo ($active_page === 'profil') ? 'active' : ''; ?>">
            <a class="nav-link" href="<?= $BASE ?>/profil.php">
    ...
    <?php elseif ($role === 'guru'): ?>
        ...
        <li class="nav-item <?php echo ($active_page === 'realtime_attendance') ? 'active' : ''; ?>">
            <a class="nav-link" href="<?= $BASE ?>/guru/realtime_attendance.php">
        ...
        <li class="nav-item <?php echo ($active_page === 'list_users_guru') ? 'active' : ''; ?>">
            <a class="nav-link" href="<?= $BASE ?>/guru/list_users_guru.php">
